...
class BotApi:
    def __init__(self, base_url: str, api_token: str):
        ...
        self.users = ApiService(
            base_url=base_url, path="api/users", api_token=api_token
        )
        self.amigo_secreto = ApiService(
            base_url=base_url, path="atlantisbot/api/amigosecreto", api_token=api_token
        )
        self.amigo_secreto_status = ApiService(
            base_url=base_url,
            path="atlantisbot/api/amigosecreto_status",
            api_token=api_token,
        )
        self.disabled_commands = ApiService(
            base_url=base_url,
            path="atlantisbot/api/disabled_commands",
            api_token=api_token,
        )
        self.ingame_names = ApiService(
            base_url=base_url, path="atlantisbot/api/ingame_names", api_token=api_token
        )
